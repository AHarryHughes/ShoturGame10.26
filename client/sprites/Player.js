...
Player.prototype = {
    ...
    create: function(State){
        ...
        State.player.pistolbullets = State.player.pistol.create(State, null);
        State.player.rifle = Rifle.prototype;
        State.player.riflebullets = State.player.rifle.create(State, null);
        State.player.shotgun = Shotgun.prototype;
        State.player.shotgunbullets = State.player.shotgun.create(State, null);
        State.player.flash = Laser.prototype;
        State.player.flashbullets = State.player.flash.create(State, null);
